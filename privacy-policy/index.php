...
<!-- Hero -->
<section class="hero--legal" aria-label="Privacy Policy">
...
<article class="legal-prose">
  ...
  <p>This Privacy Policy explains how <?php echo $companyName; ?> ("we", "us", "our") collects, uses, and protects your personal information when you visit <?php echo $domain; ?> or interact with our services.</p>
  ...
  <ul>
    ...
    <li><strong>Photo uploads:</strong> if you submit damage photos or vehicle reference images through our forms</li>
  ...
  <ul>
    ...
    <li>Schedule estimates, inspections, and windshield replacement work</li>
  ...
  <ul>
    ...
    <li><strong>Insurance carriers:</strong> when working on insurance-covered windshield replacement projects, with your explicit consent.</li>
    <li><strong>Suppliers:</strong> glass suppliers and parts vendors as necessary to complete your auto glass service.</li>
  ...
  <p>Our website may link to third-party sites (Facebook, Google Business Profile, supplier sites, manufacturer sites, etc.). We are not responsible for the privacy practices of these sites. Review their privacy policies separately.</p>
